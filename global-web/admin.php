...
// Página de administración simple para ver mensajes recibidos
$DB_HOST = '127.0.0.1';
$DB_USER = 'root';
$DB_PASS = '';
...
<body>
  <div class="wrap">
    <header class="admin-head">
      ...
      <div class="controls"><a class="btn" href="index.html">Ver sitio</a><a class="btn" href="admin_logout.php">Cerrar sesión</a></div>
    </header>
